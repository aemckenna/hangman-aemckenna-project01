...
# ------SETTINGS------
ai = True                                                                                                       # should the words be provided by a human or selected by the computer?
...
debug = True                                                                                                    # can modify this to see helpful information (such as how many words remain for a computer-generated word)
